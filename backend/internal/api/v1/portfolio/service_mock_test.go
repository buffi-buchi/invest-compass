...
type ServiceMock struct {
	...
	funcGeByUserID          func(ctx context.Context, userID uuid.UUID, limit int64, offset int64) (pa1 []model.Portfolio, err error)
...
func (mmGeByUserID *mServiceMockGeByUserID) Return(pa1 []model.Portfolio, err error) *ServiceMock {
	if mmGeByUserID.mock.funcGeByUserID != nil {
		mmGeByUserID.mock.t.Fatalf("ServiceMock.GeByUserID mock is already set by Set")
	}
...
func (mmGeByUserID *mServiceMockGeByUserID) Set(f func(ctx context.Context, userID uuid.UUID, limit int64, offset int64) (pa1 []model.Portfolio, err error)) *ServiceMock {
	if mmGeByUserID.defaultExpectation != nil {
...
func (e *ServiceMockGeByUserIDExpectation) Then(pa1 []model.Portfolio, err error) *ServiceMock {
...
func (mmGeByUserID *ServiceMock) GeByUserID(ctx context.Context, userID uuid.UUID, limit int64, offset int64) (pa1 []model.Portfolio, err error) {

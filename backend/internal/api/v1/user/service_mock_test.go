...
func (mmCreate *mServiceMockCreate) Expect(ctx context.Context, user model.User) *mServiceMockCreate {
...
// ExpectUserParam2 sets up expected param user for Service.Create
func (mmCreate *mServiceMockCreate) ExpectUserParam2(user model.User) *mServiceMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ServiceMock.Create mock is already set by Set")
	}
...
func (mmCreate *mServiceMockCreate) Inspect(f func(ctx context.Context, user model.User)) *mServiceMockCreate {
...
func (mmCreate *mServiceMockCreate) Return(u1 model.User, err error) *ServiceMock {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ServiceMock.Create mock is already set by Set")
	}
...
func (mmCreate *mServiceMockCreate) Set(f func(ctx context.Context, user model.User) (u1 model.User, err error)) *ServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mServiceMockCreate) When(ctx context.Context, user model.User) *ServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ServiceMock.Create mock is already set by Set")
	}
...
func (e *ServiceMockCreateExpectation) Then(u1 model.User, err error) *ServiceMock {
...
func (mmCreate *ServiceMock) Create(ctx context.Context, user model.User) (u1 model.User, err error) {
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.user != nil && !minimock.Equal(*mm_want_ptrs.user, mm_got.user) {
				mmCreate.t.Errorf("ServiceMock.Create got unexpected parameter user, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
